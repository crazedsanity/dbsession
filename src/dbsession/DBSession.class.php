...
namespace crazedsanity\dbsession;

use crazedsanity\session\Session;
...
class DBSession extends Session {
	 ...
	 */
	public function __construct($automaticUpgrades=true, Database $db=null) {
...
//		$this->logger = new cs_webdblogger($this->db, 'Session DB', false);
	...
	protected function flogger($msg) {
		...
		try {
			...
			$msg = '['. DBSession::$runDate .'] '. cs_get_where_called() . " -- ". $msg;
